...
def prepare_request(search_widgets_list, type_request):
    ...
    for elm in search_widgets_list:
        ...
        if (
            text != ""
            and text != "!"
            and text != ":" + defs.STRINGS["operator_or"] + ":"
            and text != ":" + defs.STRINGS["operator_and"] + ":"
        ):
            search_type = ""
                ...
                if search_type == "edition":
                    ...
                    for code, info_ed in defs.DICT_EDITIONS.items():
                        ...
                        for word in list_text_to_find:
                            ...
                            if word in py_lara(name_ed_en):
                                count_en += 1
                        if count_fr == len(list_text_to_find) or count_en == len(
                            list_text_to_find
                        ):
                    ...
                    if len(list_codes) > 0:
                        ...
                        if tmp_enum_req == "":
                            ...
                            tmp_enum_req = (
                                tmp_enum_req + " " + operator + " (" + tmp_request + ")"
                            )
                    else:
                    ...
                    if negate == 0:
                        tmp_request = (
                            """py_lower(cards.rarity) = \"""" + text_to_find + """\""""
                        )
                    else:
                        tmp_request = (
                            """py_lower(cards.rarity) != \"""" + text_to_find + """\""""
                    ...
                    if text_to_find == "":
                        ...
                        if negate == 0:
                            tmp_request = (
                                """py_lower(cards.flavor) LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                        else:
                            tmp_request = (
                                """py_lower(cards.flavor) NOT LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                    if tmp_enum_req == "":
                    ...
                    if negate == 0:
                        tmp_request = (
                            """py_lower(cards.artist) LIKE \"%"""
                            + text_to_find
                            + """%\" ESCAPE '\\'"""
                        )
                    else:
                        tmp_request = (
                            """py_lower(cards.artist) NOT LIKE \"%"""
                            + text_to_find
                            + """%\" ESCAPE '\\'"""
                        )
                    if tmp_enum_req == "":
                    ...
                    if text_to_find == "":
                        ...
                        if negate == 0:
                            tmp_request = (
                                """py_lower(cards.text) LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                        else:
                            tmp_request = (
                                """py_lower(cards.text) NOT LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                    if tmp_enum_req == "":
                    ...
                    if text_to_find.isnumeric():
                        ...
                        functions.various.message_dialog(
                            defs.STRINGS["loyalty_only_number"], 0
                        )
                        go = 0
                    ...
                    if text_to_find.isnumeric():
                        ...
                        functions.various.message_dialog(
                            defs.STRINGS["toughness_only_number"], 0
                        )
                        go = 0
                    ...
                    if text_to_find.isnumeric():
                        ...
                        functions.various.message_dialog(
                            defs.STRINGS["power_only_number"], 0
                        )
                        go = 0
                    ...
                    if text_to_find.isnumeric():
                        ...
                        functions.various.message_dialog(
                            defs.STRINGS["cmc_only_number"], 0
                        )
                        go = 0

                elif search_type == "manacost":
                    text_to_find = (
                        py_lara(text).strip().replace("{", "").replace("}", "").upper()
                    )
                    finalcost = ""
                    if text_to_find.isnumeric():
                    ...
                    if text_to_find == defs.STRINGS["white"] or text_to_find == "white":
                        text_to_find = "w"
                    if (
                        text_to_find == defs.STRINGS["colorless"]
                        or text_to_find == "colorless"
                    ):
                        text_to_find = ""
                    if text_to_find == "":
                        if negate == 0:
                    ...
                    if defs.LANGUAGE != "en":
                        # non-english helpers
                        if (
                            text_to_find == defs.STRINGS["artifact"]
                            or text_to_find == defs.STRINGS["artifacts"]
                        ):
                            text_to_find = "artifact"
                        elif (
                            text_to_find == defs.STRINGS["enchantment"]
                            or text_to_find == defs.STRINGS["enchantments"]
                        ):
                            text_to_find = "enchantment"
                        elif (
                            text_to_find == defs.STRINGS["instant"]
                            or text_to_find == defs.STRINGS["instants"]
                        ):
                            text_to_find = "instant"
                        elif (
                            text_to_find == defs.STRINGS["land"]
                            or text_to_find == defs.STRINGS["lands"]
                        ):
                            text_to_find = "land"
                        elif (
                            text_to_find == defs.STRINGS["planeswalker"]
                            or text_to_find == defs.STRINGS["planeswalkers"]
                        ):
                            text_to_find = "planeswalker"
                        elif (
                            text_to_find == defs.STRINGS["creature"]
                            or text_to_find == defs.STRINGS["creatures"]
                        ):
                            text_to_find = "creature"
                        elif (
                            text_to_find == defs.STRINGS["sorcery"]
                            or text_to_find == defs.STRINGS["sorceries"]
                        ):
                            text_to_find = "sorcery"
                        elif (
                            text_to_find == defs.STRINGS["token"]
                            or text_to_find == defs.STRINGS["tokens"]
                        ):
                            text_to_find = "token"
                        elif (
                            text_to_find == defs.STRINGS["emblem"]
                            or text_to_find == defs.STRINGS["emblems"]
                        ):
                            text_to_find = "emblem"
                    if negate == 0:
                        tmp_request = (
                    ...
                    if text == "//":
                        if negate == 0:
                            tmp_request = (
                                "cards.layout = 'split' OR cards.layout = 'aftermath'"
                            )
                        else:
                        ...
                        for word in list_text_to_find:
                            if nb_args == 0:
                                if negate == 0:
                                    tmp_request = (
                                        """(py_lara(cards.name || cards.name_chinesetrad || cards.name_chinesesimp || cards.name_french || cards.name_german || cards.name_italian || cards.name_japanese || cards.name_korean || cards.name_portuguesebrazil || cards.name_portuguese || cards.name_russian || cards.name_spanish) LIKE \"%"""
                                        + word
                                        + """%\" ESCAPE '\\')"""
                                    )
                                else:
                                    tmp_request = (
                                        """(py_lara(cards.name || cards.name_chinesetrad || cards.name_chinesesimp || cards.name_french || cards.name_german || cards.name_italian || cards.name_japanese || cards.name_korean || cards.name_portuguesebrazil || cards.name_portuguese || cards.name_russian || cards.name_spanish) NOT LIKE \"%"""
                                        + word
                                        + """%\" ESCAPE '\\')"""
                                    )
                            else:
                                if negate == 0:
                                    tmp_request = (
                                        tmp_request
                                        + """ AND (py_lara(cards.name || cards.name_chinesetrad || cards.name_chinesesimp || cards.name_french || cards.name_german || cards.name_italian || cards.name_japanese || cards.name_korean || cards.name_portuguesebrazil || cards.name_portuguese || cards.name_russian || cards.name_spanish) LIKE \"%"""
                                        + word
                                        + """%\" ESCAPE '\\')"""
                                    )
                                else:
                                    tmp_request = (
                                        tmp_request
                                        + """ AND (py_lara(cards.name || cards.name_chinesetrad || cards.name_chinesesimp || cards.name_french || cards.name_german || cards.name_italian || cards.name_japanese || cards.name_korean || cards.name_portuguesebrazil || cards.name_portuguese || cards.name_russian || cards.name_spanish) NOT LIKE \"%"""
                                        + word
                                        + """%\" ESCAPE '\\')"""
                                    )
                            nb_args += 1
                ...
                # next search_types are for the collection
                    ...
                    if text_to_find == "":
                        ...
                        if text_to_find == py_lara(defs.STRINGS["condition_mint"]):
                            text_to_find = "mint"
                        elif text_to_find == py_lara(
                            defs.STRINGS["condition_near_mint"]
                        ):
                            text_to_find = "near_mint"
                        elif text_to_find == py_lara(
                            defs.STRINGS["condition_excellent"]
                        ):
                    ...
                    if text_to_find == "":
                        ...
                        if negate == 0:
                            tmp_request = (
                                """py_lara(coll.lang) LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                        else:
                            tmp_request = (
                                """py_lara(coll.lang) NOT LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                    if tmp_enum_req == "":
                    ...
                    if text_to_find in [
                        "0",
                        "1",
                        defs.STRINGS["foil_yes"],
                        defs.STRINGS["foil_no"],
                    ]:
                        if (
                            text_to_find == defs.STRINGS["foil_no"]
                            or text_to_find == "0"
                        ):
                            text_to_find = ""
                        ...
                        functions.various.message_dialog(
                            defs.STRINGS["foil_only_yesno"], 0
                        )
                        go = 0
                    ...
                    if text_to_find == "":
                        ...
                        if negate == 0:
                            tmp_request = (
                                """py_lara(coll.loaned_to) LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                        else:
                            tmp_request = (
                                """py_lara(coll.loaned_to) NOT LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                    if tmp_enum_req == "":
                    ...
                    if text_to_find == "":
                        ...
                        if negate == 0:
                            tmp_request = (
                                """py_lara(coll.comment) LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                        else:
                            tmp_request = (
                                """py_lara(coll.comment) NOT LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                    if tmp_enum_req == "":
                    ...
                    if (
                        ...
                        if tooltip_text == defs.STRINGS["entry_eq_ad"]:
                            ...
                            math_operator = "!="
                        tmp_request = (
                            """py_int(py_remove_hyphen(coll.date)) """
                            + math_operator
                            + """ """
                            + text_to_find
                        )
                    ...
                    if text_to_find == "":
                        if negate == 0:
                            tmp_request = (
                                """coll.deck = \"\" AND coll.deck_side = \"\""""
                            )
                        else:
                            tmp_request = (
                                """coll.deck != \"\" OR coll.deck_side != \"\""""
                            )
                    else:
                        if negate == 0:
                            tmp_request = (
                                """py_lara(coll.deck) LIKE \"%"""
                                + text_to_find
                                + """%\" OR py_lara(coll.deck_side) LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                        else:
                            tmp_request = (
                                """py_lara(coll.deck) NOT LIKE \"%"""
                                + text_to_find
                                + """%\" AND py_lara(coll.deck_side) NOT LIKE \"%"""
                                + text_to_find
                                + """%\" ESCAPE '\\'"""
                            )
                    if tmp_enum_req == "":
                    ...
                    if text_to_find.isnumeric():
                        ...
                        functions.various.message_dialog(
                            defs.STRINGS["quantity_card_coll_only_number"], 0
                        )
                        go = 0
...
def check_db():
    ...
    if os.path.isfile(os.path.join(defs.CACHEMC, "datedb")) == False:
        ...
        fichierdatedb = open(
            os.path.join(defs.CACHEMC, "datedb"), "r", encoding="UTF-8"
        )
...
def check_db2():
    def show_loading():
        defs.MAINWINDOW.widget_overlay.get_child().set_markup(
            "<b><big>" + defs.STRINGS["loading"] + "</big></b>"
        )
        functions.various.force_update_gui(0)

    def show_loading_oldformat():
        defs.MAINWINDOW.widget_overlay.get_child().set_markup(
            "<b><big>" + defs.STRINGS["import_oldformat"] + "</big></b>"
        )
        functions.various.force_update_gui(0)
    ...
    if os.path.isfile(os.path.join(defs.CACHEMC, "datedb")):
        ...
        fichierdatedb.close()
        if os.path.isfile(
            os.path.join(defs.CACHEMC, "dbmc_" + datebddcartes + ".sqlite.tar.xz")
        ):
            try:
                tar = tarfile.open(
                    os.path.join(
                        defs.CACHEMC, "dbmc_" + datebddcartes + ".sqlite.tar.xz"
                    )
                )
        ...
        if os.path.isfile(os.path.join(defs.CACHEMC, "datedb_newtmp")) == False:
            try:
                urllib.request.urlretrieve(
                    ...
                    os.path.join(defs.CACHEMC, "datedb_newtmp"),
                )
            except:
                GLib.idle_add(
                    functions.various.message_dialog,
                    defs.STRINGS["error_download_db"],
                    0,
                )
                go = 0
        if go == 1:
            fichierdatedb_tmp = open(
                os.path.join(defs.CACHEMC, "datedb_newtmp"), "r", encoding="UTF-8"
            )
            ...
            if os.path.isfile(
                os.path.join(
                    defs.CACHEMC, "dbmc_" + datebddcartes_new + ".sqlite.tar.xz_newtmp"
                )
            ):
                os.remove(
                    os.path.join(
                        defs.CACHEMC,
                        "dbmc_" + datebddcartes_new + ".sqlite.tar.xz_newtmp",
                    )
                )
            ...
            if StrictVersion(mcversion) >= StrictVersion(minversionbdd_new):
                try:
                    ...
                    if os.path.isfile(os.path.join(defs.CACHEMC, "datedb")):
                        ...
                        if os.path.isfile(
                            os.path.join(
                                defs.CACHEMC, "dbmc_" + datebddcartes_old + ".sqlite"
                            )
                        ):
                            os.remove(
                                os.path.join(
                                    defs.CACHEMC,
                                    "dbmc_" + datebddcartes_old + ".sqlite",
                                )
                            )
                    if os.path.isfile(
                        os.path.join(
                            defs.CACHEMC, "dbmc_" + datebddcartes_new + ".sqlite.tar.xz"
                        )
                    ):
                        os.remove(
                            os.path.join(
                                defs.CACHEMC,
                                "dbmc_" + datebddcartes_new + ".sqlite.tar.xz",
                            )
                        )
                    os.rename(
                        os.path.join(defs.CACHEMC, "datedb_newtmp"),
                        os.path.join(defs.CACHEMC, "datedb"),
                    )
                    os.rename(
                        os.path.join(
                            defs.CACHEMC,
                ...
                GLib.idle_add(
                    functions.various.message_dialog, defs.STRINGS["warning_ver_db"], 0
                )
    else:
        GLib.idle_add(
...
def check_update_db():
    ...
    GLib.idle_add(
        defs.MAINWINDOW.widget_overlay.get_child().set_markup,
        "<b><big>" + defs.STRINGS["checking_db_update"] + "</big></b>",
    )
            ...
            if StrictVersion(mcversion) < StrictVersion(minversionbdd_new):
                ...
                if datebddcartes_new > datebddcartes:
                    ...
                    dialogconfirm = Gtk.MessageDialog(
                        ...
                        defs.STRINGS["new_update_db"].replace("%%%", infoversion)
                        + infochangelog,
                    )
            ...
            if names_splited[2] != name:
                ...
                for data2 in sdf_all_data:
                    ...
                    if (
                        name2 == meld_to
                        and layout2 == layout
                        and edition2 == edition
                        and nb_variante2 == nb_variante
                        and name in names2.split("|")
                    ):
